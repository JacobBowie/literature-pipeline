...
class ErrorHandler:
    ...
    def _fix_missing_attribute(self, error: ExpatError, xml: str) -> str:
        ...
        counter = 0
        # VENDORED FIX (2026-04-28): upstream bug — `xml` was never reassigned
        # inside the loop, so this always re-searched the original string and
        # the counter cap was the only thing preventing an infinite loop.
        # The intended behavior is iterative substitution; restored here.
